...
@section('content_header')
    <h1>Listado de Asignaciones para Registro de Asistencias</h1>
    <hr>
@stop
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-warning text-dark">
                    <h5 class="modal-title" id="modalReporteLabel{{ $asignacion->id }}">Generar Reporte de Asistencias</h5>
            ...
            table = $('#asignacionesTable').DataTable({
                ...
                "buttons": [
                    ...
                    },
                    {
                        ...
                        text: 'Excel',
                        className: 'd-none',
                        title: 'Listado de Asignaciones para Asistencias',
                        exportOptions: {
                            columns: ':not(:last-child)'
                        }
                    },
